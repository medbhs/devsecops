...
def main(args=sys.argv):
    ...
    operation.add_argument(
        "-o", metavar="OUTPUTFILE", help="Where to write the output.  Defaults to standard output."
    )

    operation.add_argument(
        "INPUTFILE", nargs="?", help="Where to read the input.  Defaults to standard input."
    )
